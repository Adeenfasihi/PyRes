%------------------------------------------------------------------------------
% File     : MED008+1 : TPTP v7.5.0. Released v3.2.0.
% Domain   : Medicine
...
% Status   : Theorem
% Rating   : 0.14 v7.5.0, 0.24 v7.4.0, 0.00 v7.0.0, 0.14 v6.4.0, 0.00 v6.2.0, 0.18 v6.1.0, 0.24 v6.0.0, 0.25 v5.5.0, 0.38 v5.4.0, 0.35 v5.3.0, 0.43 v5.2.0, 0.29 v5.0.0, 0.25 v4.1.0, 0.22 v4.0.1, 0.32 v4.0.0, 0.30 v3.7.0, 0.33 v3.5.0, 0.12 v3.4.0, 0.25 v3.3.0, 0.33 v3.2.0
...
%            Number of variables   :   95 (   0 sgn;  92   !;   3   ?)
